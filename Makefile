...
CC_SDL2_OPTIONS_WINDOWS = -I$(SDL2_MINGW_WINDOWS)/include/SDL2 -L$(SDL2_MINGW_WINDOWS)/lib -lSDL2main -lSDL2
...
CC_WINDOWS_OPTIONS = -mwindows -L/usr/local/lib -lmingw32 $(CC_SDL2_OPTIONS_WINDOWS) $(CC_QUICKJS_OPTIONS_WINDOWS)
